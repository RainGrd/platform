...
public class DateTimeUtil {
    ...
    public static String convertLongToStringYMDHMS(Long time) {
        ...
        /*格式化*/
        DateTimeFormatter ftf = DateTimeFormatter.ofPattern(CommonsEnum.YMD_HMS.getValue());
    ...
    public static String convertDateCustomStringFormat(Date date) {
        return convertDateCustomStringFormat(date, CommonsEnum.YMD_HMS.getValue());
    }
    ...
    public static String ConvertDateStringYMD(Date date) {
        return convertDateCustomStringFormat(date, CommonsEnum.YMD.getValue());
    }
}
