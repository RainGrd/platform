        ...
        <div class="col-md-3 left_col menu_fixed">
            <div class="left_col scroll-view">
                <div class="navbar nav_title" style="border: 0;">
                    <a href="manager/backend/main" class="site_title"><i
                ...
                <div class="profile">
                    <div class="profile_pic">
                        <img src="statics/images/img2.jpg" alt="..."
                        ...
                        <ul class="nav side-menu">
                            <li><a><i class="fa fa-home"></i> 手游管理 <span class="fa fa-chevron-down"></span></a>
                                <ul class="nav child_menu">
                                    <li><a href="backend/toAppList.do">手游审核</a>
                                    </li>
                            ...
                            <a href="javascript:;" class="user-profile dropdown-toggle" data-toggle="dropdown"
                               aria-expanded="false">
                                <img src="statics/images/img2.jpg"
                                     alt="">${sessionScope.userSession.userCode }
                                <span class=" fa fa-angle-down"></span>
                            </a>
                            <ul class="dropdown-menu dropdown-usermenu pull-right">
                                <li><a href="backend/loginOut.do"><i
