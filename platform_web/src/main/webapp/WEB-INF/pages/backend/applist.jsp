...
<div class="row">
    ...
    <div class="col-md-12">
        <div class="x_panel">
            <div class="x_title">
                <h2>
                    手游 审核列表 <i class="fa fa-user"></i><small>${sessionScope.userSession.userName}
            ...
            <div class="x_content">
                <form method="get" action="">
                    ...
                    <ul>
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <select id="queryFlatformId" name="queryFlatformId" class="form-control">
                                        <c:if test="${dictionaryList != null }">
                                            ...
                                            <c:forEach var="dataDictionary" items="${dictionaryList}">
                                                <option
                        ...
                        <li>
                            <button id="queryBtn" type="button" class="btn btn-primary"> 查 &nbsp;&nbsp;&nbsp;&nbsp;询</button>
                        </li>
                    </ul>
                </form>
            </div>
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <table id="datatable-responsive"
                                ...
                                <tbody id="tableData">
                                <%--  <c:forEach var="appInfo" items="${appInfoPageInfo.list}" varStatus="status">
                    ...
                    <div class="row">
                        <div class="col-sm-5">
                            <div class="dataTables_info" id="datatableInfo"
                                 role="status" aria-live="polite">共<span id="total"></span>条记录
                                <span id="navigateFirstPage"></span>/<span id="navigateLastPage"></span>页
                            </div>
                        </div>
                        <div class="col-sm-7">
                            <div class="dataTables_paginate paging_simple_numbers"
                                ...
                                <ul class="pagination">
                                    <li class="paginate_button previous"><a id="firstBtn"
