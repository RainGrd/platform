...
<div class="row">
    <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
            <div class="x_title">
                <h2>新增手游基础信息 <i class="fa fa-user"></i><small>${sessionScope.devUserSession.devName}</small></h2>
                <div class="clearfix"></div>
            </div>
            <div class="x_content">
                ...
                <form class="form-horizontal form-label-left"  method="post"
                    ...
                    <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                            <select name="categoryLevel1" id="categoryLevel1" class="form-control"
                                    required="required">
                                <option value="">--请选择--</option>
                                <c:forEach items="${categoryLevel1List}" var="categoryLevel" varStatus="status">
                                    <option value="${categoryLevel.id}">${categoryLevel.categoryName}</option>
                                </c:forEach>
                            </select>
                        </div>
                    </div>
                    ...
                    <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                            <select name="categoryLevel2" id="categoryLevel2" class="form-control"
                                    required="required">
                                <option value="">--请选择--</option>
                                <c:forEach items="${categoryLevel2List}" var="categoryLevel" varStatus="status">
                                    <option value="${categoryLevel.id}">${categoryLevel.categoryName}</option>
                                </c:forEach>
                    ...
                    <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                            <select name="categoryLevel3" id="categoryLevel3" class="form-control"
                                    required="required">
                                <option value="">--请选择--</option>
                                <c:forEach items="${categoryLevel3List}" var="categoryLevel" varStatus="status">
                                    <option value="${categoryLevel.id}">${categoryLevel.categoryName}</option>
                                </c:forEach>
                    ...
                    <div class="item form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="status">手游状态 <span
                                class="required">*</span>
                        </label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
