...
<div class="row">
    <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
            <div class="x_title">
                <h2>修改手游最新版本信息 <i class="fa fa-user"></i><small>${sessionScope.devUserSession.devName}</small></h2>
                <div class="clearfix"></div>
            </div>
            <div class="x_title">
                <h2>历史版本列表</h2>
            ...
            <div class="x_content1">
              ...
              <textarea id="versionInfo" name="versionInfo" required="required"
                  ...
                  ${appVersion.versionInfo }</textarea>
                        ...
                        <div class="item form-group">
                            <label class="control-label col-md-3 col-sm-3 col-xs-12" for="attach">apk文件 <span
                                    class="required">*</span>
                            </label>
                            <div class="col-md-6 col-sm-6 col-xs-12">
