            ...
            <div class="x_content">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                            ...
                            <select name="flatformId" id="flatformId" class="form-control" required="required">
                                ...
                                <c:forEach items="${dictionaryList}" var="dictionary">
                                    <option value="${dictionary.id}">${dictionary.valueName}</option>
                                </c:forEach>
                            </select>
                        </div>
                    </div>
              ...
              <textarea id="appInfo" name="appInfo" required="required"
                  ...
                  ${appInfo.appInfo}</textarea>
                    ...
                    <div class="item form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="uploadFile">LOGO图片 <span
                                class="required">*</span>
                        </label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                            ...
                            <div id="uploadFile" style="display: none">
                                ...
                                <p><span
                                        style="color:red;font-weight: bold;">*注：1、大小不得超过500k.2、图片格式：jpg、png、jpeg</span>
                                </p>
                            </div>
                            <div id="logoFile"></div>
                            ${fileUploadError}
